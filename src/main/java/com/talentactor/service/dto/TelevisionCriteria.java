...
/**
 * Criteria class for the Television entity. This class is used in TelevisionResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /televisions?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TelevisionCriteria implements Serializable {
    ...
    private StringFilter cameraman;
    ...
    public StringFilter getCameraman() {
        return cameraman;
    }

    public void setCameraman(StringFilter cameraman) {
    ...
    public String toString() {
        return "TelevisionCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (title != null ? "title=" + title + ", " : "") +
                (director != null ? "director=" + director + ", " : "") +
                (cameraman != null ? "cameraman=" + cameraman + ", " : "") +
                (link != null ? "link=" + link + ", " : "") +

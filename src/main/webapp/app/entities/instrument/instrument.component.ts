...
export class InstrumentComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.instrumentService
            ...
            .subscribe(
                (res: HttpResponse<IInstrument[]>) => this.paginateInstruments(res.body, res.headers),
    ...
    trackId(index: number, item: IInstrument) {
        return item.id;
    }
    ...
    private paginateInstruments(data: IInstrument[], headers: HttpHeaders) {

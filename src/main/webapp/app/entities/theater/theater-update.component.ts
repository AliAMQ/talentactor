        ...
        this.profileService.findByUserId(this.principal.getId()).subscribe((res: HttpResponse<IProfile>) => {
            ...
            if (this.theater.id !== undefined) {
                if (this.selectedFiles !== undefined) {
                    if (this.theater.imagepath !== null) {
                        this.fileManagementService.deleteFile(this.theater.imagepath);
                    }
                    if ((document.getElementById('imagepath1') as HTMLImageElement).hidden !== true) {
                        this.theater.imagepath = this.upload('imagepath1');
                    } else {
                        this.theater.imagepath = null;
                    }
                } else {
                    if ((document.getElementById('imagepath1') as HTMLImageElement).hidden === true) {
                        if (this.theater.imagepath !== null) {
                ...
                if (this.selectedFiles2 !== undefined) {
                    if (this.theater.videopath !== null) {
                        this.fileManagementService.deleteFile(this.theater.videopath);
                    }
                    if ((document.getElementById('videopath1') as HTMLVideoElement).hidden !== true) {
                        this.theater.videopath = this.upload('videopath1');
                    } else {
                        this.theater.videopath = null;
                    }
                } else {
                    if ((document.getElementById('videopath1') as HTMLVideoElement).hidden === true) {
                        if (this.theater.videopath !== null) {

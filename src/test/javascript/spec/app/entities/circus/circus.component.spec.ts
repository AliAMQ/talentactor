...
import { CircusComponent } from 'app/entities/circus/circus.component';
import { CircusService } from 'app/entities/circus/circus.service';
import { Circus } from 'app/shared/model/circus.model';

describe('Component Tests', () => {
    describe('Circus Management Component', () => {
        let comp: CircusComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CircusComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.circuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

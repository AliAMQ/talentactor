...
import { CombatComponent } from 'app/entities/combat/combat.component';
import { CombatService } from 'app/entities/combat/combat.service';
import { Combat } from 'app/shared/model/combat.model';

describe('Component Tests', () => {
    describe('Combat Management Component', () => {
        let comp: CombatComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CombatComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.combats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

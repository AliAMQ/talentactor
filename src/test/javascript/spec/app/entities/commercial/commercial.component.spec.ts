...
import { CommercialComponent } from 'app/entities/commercial/commercial.component';
...
describe('Component Tests', () => {
    describe('Commercial Management Component', () => {
        let comp: CommercialComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CommercialComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.commercials[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
import { CyclingComponent } from 'app/entities/cycling/cycling.component';
import { CyclingService } from 'app/entities/cycling/cycling.service';
import { Cycling } from 'app/shared/model/cycling.model';

describe('Component Tests', () => {
    describe('Cycling Management Component', () => {
        let comp: CyclingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CyclingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cyclings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

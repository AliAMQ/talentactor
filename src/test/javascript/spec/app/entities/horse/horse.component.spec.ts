...
import { HorseComponent } from 'app/entities/horse/horse.component';
import { HorseService } from 'app/entities/horse/horse.service';
import { Horse } from 'app/shared/model/horse.model';

describe('Component Tests', () => {
    describe('Horse Management Component', () => {
        let comp: HorseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HorseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.horses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

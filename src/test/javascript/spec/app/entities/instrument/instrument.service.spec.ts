    ...
    describe('Instrument Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/instruments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Instrument', () => {
                service.create(new Instrument(null)).subscribe(received => {
            ...
            it('should update a Instrument', () => {
                service.update(new Instrument(123)).subscribe(received => {

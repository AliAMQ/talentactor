...
import { InternetComponent } from 'app/entities/internet/internet.component';
...
describe('Component Tests', () => {
    describe('Internet Management Component', () => {
        let comp: InternetComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InternetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.internets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

...
import { PrintComponent } from 'app/entities/print/print.component';
import { PrintService } from 'app/entities/print/print.service';
import { Print } from 'app/shared/model/print.model';

describe('Component Tests', () => {
    describe('Print Management Component', () => {
        let comp: PrintComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PrintComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.prints[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

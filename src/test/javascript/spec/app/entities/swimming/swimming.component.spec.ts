...
import { SwimmingComponent } from 'app/entities/swimming/swimming.component';
...
describe('Component Tests', () => {
    describe('Swimming Management Component', () => {
        let comp: SwimmingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SwimmingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.swimmings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

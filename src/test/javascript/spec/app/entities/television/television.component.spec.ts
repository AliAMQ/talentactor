...
import { TelevisionComponent } from 'app/entities/television/television.component';
...
describe('Component Tests', () => {
    describe('Television Management Component', () => {
        let comp: TelevisionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TelevisionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.televisions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

    ...
    describe('Theater Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TheaterComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.theaters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });

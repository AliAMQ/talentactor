    ...
    describe('Theater Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/theaters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Theater', () => {
                service.create(new Theater(null)).subscribe(received => {
            ...
            it('should update a Theater', () => {
                service.update(new Theater(123)).subscribe(received => {

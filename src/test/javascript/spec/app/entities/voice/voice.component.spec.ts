...
import { VoiceComponent } from 'app/entities/voice/voice.component';
import { VoiceService } from 'app/entities/voice/voice.service';
import { Voice } from 'app/shared/model/voice.model';

describe('Component Tests', () => {
    describe('Voice Management Component', () => {
        let comp: VoiceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VoiceComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.voices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
